...
description: Run final read-only validation for a task. Use when user runs $speccraft.validate or asks to validate an approved, tested task. Supports an "auto" mode that runs unattended, with no human approval gate.
---
