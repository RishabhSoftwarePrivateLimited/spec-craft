...
description: Generate integration tests for an approved implementation and unit tests (backend only). Use when user runs $speccraft.integration-test or asks to write integration tests for a backend task.
---
