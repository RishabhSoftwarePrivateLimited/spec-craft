---
name: speccraft.change
description: Run CR eligibility check and cascade for a change request. Use when user runs $speccraft.change or submits a change request against an existing story.
---
...
Input: read `<CR-file> <original-story-id>` the user supplied after invoking this skill.
