...
Input: $ARGUMENTS (optional leading `auto` token, then business spec file path under `spec/business/`, then remainder = tech stack description, e.g. `spec/business/checkout/STORY-042.md "React + Vite frontend, Node/Express backend, Postgres via Prisma, REST API"` or `auto spec/business/checkout/STORY-042.md "..."`)
