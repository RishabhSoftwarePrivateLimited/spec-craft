...
Input: $ARGUMENTS (optional leading `auto` token, then `<lld-fe-file> <lld-be-file>` when Layer Scope = both, or `<lld-file>` for a single-layer project, e.g. `auto spec/lld/checkout/LLD-FRONTEND-042.md spec/lld/checkout/LLD-BACKEND-042.md`)
