...
Input: ${input:arguments:optional leading "auto" token, then business spec file path, then a quoted tech stack description, e.g. spec/business/checkout/STORY-042.md "React + Vite frontend, Node/Express backend, Postgres via Prisma, REST API" or auto spec/business/checkout/STORY-042.md "..."}
