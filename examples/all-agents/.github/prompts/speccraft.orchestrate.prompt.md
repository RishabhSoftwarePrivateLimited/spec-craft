...
Input: ${input:arguments:business spec file path, optionally preceded by "auto"}

Parse the input as an optional leading `auto` token followed by the business spec file path. `auto` present -> auto mode; absent -> interactive mode (default).
