...
import { listTasks, createTask } from '../../src/controllers/tasks.controller'
...
test('listTasks responds 200 with the service result', (t) => {
  const tasks = [{ id: '1', title: 'Buy milk', createdAt: '2026-01-01T00:00:00.000Z' }]
...
test('createTask responds 201 with the created task for a valid title', (t) => {
  const created = { id: '1', title: 'Buy milk', createdAt: '2026-01-01T00:00:00.000Z' }
