...
> **Live demo, generated by `@rspl/speccraft@0.1.0`.** This is the greenfield-demo instance — see [`WALKTHROUGH.md`](WALKTHROUGH.md) for exactly what was run to produce it. Everything below is the boilerplate's own generic documentation, copied in as-is at scaffold time.
