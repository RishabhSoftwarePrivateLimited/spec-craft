...
Input: $ARGUMENTS (first token = business spec file path under `spec/business/`, remainder = tech stack description, e.g. `spec/business/checkout/STORY-042.md "React + Vite frontend, Node/Express backend, Postgres via Prisma, REST API"`)
